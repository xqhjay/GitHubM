...
- **Endpoint**：`POST https://app-bgc5z86utjwh-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-bgc5z86utjwh-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
