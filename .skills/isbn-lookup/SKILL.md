...
- **Endpoint**：`POST https://app-bm0s7wqmrksh-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-bm0s7wqmrksh-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
